...
INSERT INTO users (first_name,last_name,email,gender,occupation_id) VALUES ("Roman","Kaderov","roman.kaderov@bk.ru","male",19);
...
((SELECT id FROM users WHERE email="roman.kaderov@bk.ru" ),
